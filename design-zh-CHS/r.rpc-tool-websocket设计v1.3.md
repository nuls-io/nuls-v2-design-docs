...
如果你想知道websocket的具体设计，请逐步阅读本文档，这大约会花费你10分钟的时间

如果你只是想知道如何使用，请跳转到章节《7.1 如何使用》（敲黑板：只需要看7.1）

如果你想进行进一步的沟通，请联系nuls团队
...
![](E:\tony\nuls\nuls_2.0_docs\design-zh-CHS\image\tools-rpc\Websocket-Tool-package.png)
